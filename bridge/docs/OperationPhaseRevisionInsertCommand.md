# swagger.model.OperationPhaseRevisionInsertCommand
...
**insertionTimestamp** | [**DateTime**](DateTime.md) | The timestamp where the operation phase command should be inserted | [default to null]
**operationPhaseCommand** | [**OperationPhaseCommand**](OperationPhaseCommand.md) |  | [optional] [default to null]

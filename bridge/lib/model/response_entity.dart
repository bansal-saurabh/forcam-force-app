...
class ResponseEntity {
  ...
  ResponseEntity.fromJson(Map<String, dynamic> json) {
    if (json == null) return;
    body = new Object.fromJson(json['body']);
